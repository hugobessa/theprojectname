## Project bootstrap [![main](https://github.com/chocoelho/django-react-boilerplate/actions/workflows/main.yml/badge.svg)](https://github.com/chocoelho/django-react-boilerplate/actions/workflows/main.yml)
...
- Open the `/backend/.env` file on a text editor and uncomment the line `DATABASE_URL=postgres://theprojectname:password@db:5432/theprojectname`
...
- Open the `/backend/.env` file on a text editor and do one of the following:
  ...
  - If you wish to use PostgreSQL locally, uncomment and edit the line `DATABASE_URL=postgres://theprojectname:password@db:5432/theprojectname` in order to make it correctly point to your database URL
